 ...
 * Validates inputs (name, email, password, year group, major).
 * Ensures email is an Ashesi address (ashesi.edu.gh)  and password meets requirements.
 * Checks for any existing users with the same email.
 * Creates a new user, and stores their session data.
